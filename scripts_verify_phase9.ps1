...
try {
    ...
    if ($heads.Count -ne 1 -or $heads[0] -notmatch "20260815_0012") { throw "Unexpected Alembic heads: $heads" }
    Pop-Location
    ...
    Write-Host "Phase 9.3 verification completed."
