...
try {
    ...
    Push-Location "apps/backend"
    python -m pytest tests/test_phase9_migration.py tests/test_phase9_1_migration.py tests/test_phase9_2_migration.py tests/test_phase9_4_migration.py tests/test_phase9_5_migration.py tests/test_phase9_7_migration.py tests/test_medication_catalog_migration.py -q
