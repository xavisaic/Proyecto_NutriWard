...
(cd apps/backend && test "$(alembic heads | wc -l | tr -d ' ')" -eq 1 && alembic history | grep -q "20260805_0008" && alembic upgrade head --sql >/dev/null && alembic downgrade 20260805_0008:20260805_0007 --sql >/dev/null && alembic downgrade 20260805_0007:20260731_0006 --sql >/dev/null)
