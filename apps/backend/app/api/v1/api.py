...
from app.api.v1.endpoints.clinical_context import router as clinical_context_router
from app.api.v1.endpoints.health import router as health_router
from app.api.v1.endpoints.food_production import router as food_production_router
...
api_router.include_router(food_production_router)
